...
<div class="container-fluid">
	...
	<div class="col-md-8">
		<div id="show">Edit the Given Notice Title and Description in
			the given box and click on update</div>
		<table style="background-color: white">
			...
			<tr>
				<td><%=noticeId%></td>
				<td style="width: 100%;"><textarea name="title" readonly><%=noticeTitle%></textarea></td>
				<td><textarea name="info" cols="60" readonly><%=noticeDesc%></textarea></td>
				<td><a href="updateNoticeForm.jsp?nid=<%=noticeId%>"><button>Update</button></a></td>
			</tr>
			<%
			}
			%>
